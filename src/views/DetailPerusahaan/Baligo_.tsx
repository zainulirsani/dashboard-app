...
const BaligoView = ({ data }: { data: baligoType }) => {
    ...
    useEffect(() => {
        if (data.pengiriman_count && data.pengiriman_count.length > 0) {
          // Ambil semua tahun dari data
          const years = data.pengiriman_count
        ...
        <section className="p-3">
            ...
            <div className="row px-1 gap-4 justify-content-center mb-3">
                <div className={`${styles.largeCard} col-xl-2 col-12 card`}>
                    ...
                    <p className={`${styles.largeCard__description} text-center`}>Total Customers</p>
                </div>
                ...
                <div className={`${styles.largeCard} col-xl-2 col-12 card`}>
                    ...
                    <p className={`${styles.largeCard__description} text-center`}>Total Couriers</p>
                </div>

                <div className={`${styles.largeCard} col-xl-2 col-12 card`}>
                    <div className={`${styles.largeCard__content} d-flex align-items-center justify-content-center`}>
                        <div className={`${styles.largeCard__content__leftSection} text-center`}>
                    ...
                    <p className={`${styles.largeCard__description} text-center`}>Total Vehicles</p>
                </div>
                ...
                <div className={`${styles.largeCard} col-xl-2 col-12 card`}>
                    ...
                    <p className={`${styles.largeCard__description} text-center`}>Total Deliveries in Progress</p>
                </div>
                ...
                <div className={`${styles.largeCard} col-xl-2 col-12 card`}>
                    ...
                    <p className={`${styles.largeCard__description} text-center`}>Total Completed Deliveries</p>
                </div>
            ...
            <div className="px-1 gap-4 justify-content-center mb-3">
                        ...
                        <div className="col-xl-12 col-md-12 col-sm-12">
                            <div className={`${styles.customCard} card`}>
                                <div className={styles.customCard__cardHeader}>
                                    <h6 className="mb-0">User Data</h6>
                                </div>
                ...
                {showDetailKurir && (
                    <div className="row g-4">
                        <div className="col-xl-12 col-md-12 col-sm-12">
                            <div className={`${styles.customCard} card`}>
                                <div className={styles.customCard__cardHeader}>
                                    <h6 className="mb-0">Couriers Data</h6>
                                </div>
                                <div className={`${styles.customCard__cardBody} collapse show`}>
                                    <DataTable
                ...
                <div className="row g-4">
                    <div className="col-xl-12 col-md-12 col-sm-12">
                        <div className={`${styles.customCard} card`}>
                            <div className={styles.customCard__cardHeader}>
                                <h6 className="mb-0">Delivery Data</h6>
                            </div>
                            <div className={`${styles.customCard__cardBody} collapse show`}>
                                <LineChart
                                    chartData={getDataForChart()!}
                                    titleX="Date"
                                    titleY="Total Deliveries"
                                    isNominal={false}
                                />
                            </div>
                        </div>
                ...
                <div className="row g-4 mt-2">
                    <div className="col-xl-6 col-12">
                        <div className={`${styles.customCard} card`}>
                            <div className={styles.customCard__cardHeader}>
                                <h6 className="mb-0">Number of Deliveries per Destination City</h6>
                            </div>
                            <div className={`${styles.customCard__cardBody} collapse show`}>
